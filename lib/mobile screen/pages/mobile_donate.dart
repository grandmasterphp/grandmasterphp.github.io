...
class DonateMobilePage extends StatefulWidget {
  const DonateMobilePage({super.key});

  @override
  State<DonateMobilePage> createState() => _DonateMobilePageState();
}

class _DonateMobilePageState extends State<DonateMobilePage> {
